...
import cn.icebg.hospital.mapper.LogAccountLoginMapper;
...
public class LogAccountLoginServiceImpl implements ILogAccountLoginService {
     ...
     */
    @Override
    public boolean insertByOpenId(String openId) {
        Optional<PowerAccount> accountOptional = powerAccountService.getByOpenId(openId);
