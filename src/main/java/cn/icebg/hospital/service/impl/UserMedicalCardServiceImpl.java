...
import cn.icebg.hospital.dto.param.UserMedicalCardParam;
import cn.icebg.hospital.dto.param.UserMedicalCardUpdateParam;
import cn.icebg.hospital.entity.UserMedicalCard;
import cn.icebg.hospital.entity.UserMedicalCardExample;
import cn.icebg.hospital.entity.UserMedicalCardRelation;
import cn.icebg.hospital.entity.UserMedicalCardRelationExample;
import cn.icebg.hospital.mapper.UserMedicalCardMapper;
import cn.icebg.hospital.mapper.UserMedicalCardRelationMapper;
import cn.icebg.hospital.service.IUserMedicalCardService;
import cn.icebg.hospital.dto.UserMedicalCardDTO;
...
public class UserMedicalCardServiceImpl implements IUserMedicalCardService {
    ...
    public boolean insert(Long accountId, UserMedicalCardParam param) {
        ...
        if (countIdentificationNumber(param.getIdentificationNumber())) {
            ...
            if (cardOptional.isPresent()) {
                Long cardId = cardOptional.get().getId();
                if (!(countRelationExit(accountId))) {
                    return insertRelation(accountId, param.getType(), cardId);
                }
            }
        }
     ...
     */
    @Override
    public boolean countRelationExit(Long accountId) {
