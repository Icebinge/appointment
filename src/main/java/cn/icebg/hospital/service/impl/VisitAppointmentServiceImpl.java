...
import cn.icebg.hospital.mapper.VisitAppointmentMapper;
...
import static cn.icebg.hospital.dto.TimePeriodEnum.AM;
import static cn.icebg.hospital.dto.TimePeriodEnum.PM;
...
public class VisitAppointmentServiceImpl implements IVisitAppointmentService {
    ...
    private static final int MAX_PEOPLE_OF_TIME_PERIOD = 1;
     ...
     */
    @Override
    public List<VisitAppointmentWithQueueDTO> listAllAppointmentById(Long planId, Integer pageNum, Integer pageSize) {
