...
public interface IPowerAccountService {
    ...
    Optional<PowerAccount> getByOpenId(String openId);
    ...
    Optional<String> login2(String name, String password);
    ...
    boolean checkPassword2(Long id, String password);
    ...
    Optional<String> weChatLogin(String openId);
    ...
    void updateLoginTimeByOpenId(String openId);
}
