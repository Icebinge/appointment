...
import cn.icebg.hospital.dto.param.PowerAccountUpdatePasswordParam;
...
public class PowerAccountController {
    ...
    public CommonResult<String> loginAccount(@RequestParam String name, @RequestParam String password) {
        ...
        Optional<String> stringOptional = accountService.login(name, password);//原登录方法
//        Optional<String> stringOptional = accountService.login2(name, password);
