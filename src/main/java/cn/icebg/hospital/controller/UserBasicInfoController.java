...
import cn.icebg.hospital.component.WxComponent;
...
import cn.icebg.hospital.dto.UserInfoDTO;
import cn.icebg.hospital.dto.param.PowerAccountPasswordParam;
import cn.icebg.hospital.dto.param.UserBasicInfoParam;
...
//        }
    ...
    @ApiOperation(value = "检查手机号是否已注册", notes = "传入 手机号")
    @ApiImplicitParam(name = "phone", value = "手机号", paramType = "query", dataType = "String", required = true)
    @RequestMapping(value = "/basic/checkPhone", method = RequestMethod.GET)
    public CommonResult checkPhoneNumber(@RequestParam String phone) {
